...
echo "  Pane resize (coarse): prefix + H/J/K/L (3 cells)"
echo "  Pane resize (fine)  : prefix + Alt+H/J/K/L (1 cell)"
echo "  Split horiz         : prefix + |"
echo "  Split vert          : prefix + -"
echo "  Bottom pane 25%     : prefix + _  (create or focus)"
echo "  Right pane 33%      : prefix + \\  (create or focus)"
echo "  Zoom pane           : prefix + z"
echo "  Reload config       : prefix + r"
echo "  Switch window       : Alt+1..9  or  Alt+[/]"
echo "  Cycle window        : Alt+Tab / Alt+Shift+Tab"
echo "  Last window         : prefix + Tab"
echo "  Swap window         : prefix + Shift+← / Shift+→"
...
echo "  Inner cycle window  : Ctrl+Alt+Tab / Ctrl+Alt+Shift+Tab"
echo "  Inner new window    : prefix + Ctrl+c"
echo "  Inner close pane    : prefix + Ctrl+x"
echo "  Inner split horiz   : prefix + Ctrl+|"
echo "  Inner split vert    : prefix + Ctrl+-"
echo "  Inner bottom pane   : prefix + Ctrl+_"
echo "  Inner right pane    : prefix + Ctrl+\\"
echo "  Inner swap window   : prefix + Ctrl+Shift+← / Ctrl+Shift+→"
echo "  Inner resize coarse : prefix + Ctrl+H/J/K/L"
echo "  Inner resize fine   : prefix + Ctrl+Alt+H/J/K/L"
